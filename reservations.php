          ...
          <li class="nav-item">
            <div class="dropdown">
              ...
              <div class="dropdown-content">
                <a href="board.php" class="dr">BOARD</a> <hr>
        ...
        <div class="reservation-form" >
            ...
            <div style="height:800px;background-color:white;">
                ...
                <form method="post" action="//submit.form" onSubmit="return validateForm();">
                    ...
                    <div id='name' style="padding-bottom: 18px;font-size : 50px; font-family:  Brush Script MT, Brush Script Std, cursive; color:#87a3ab;" >Table Reservation</div>
                    <div id='name' style="padding-bottom: 18px;font-size : 18px;">We would be glad to reserve a table for you at our restaurant!</div>
...
function showSlides(n) {
  ...
  slides[slideIndex-1].style.display = "block";  gi
...
In Western countries, most mid-to high-range restaurants serve alcoholic beverages such as beer and wine. Some restaurants serve all the major meals, such as breakfast, lunch, and dinner (e.g., major fast food chains, diners, hotel restaurants, and airport restaurants). Other restaurants may serve only a single meal (for example, a pancake house may only serve breakfast) or they may serve two meals (e.g., lunch and dinner).
            ...
            <section class="booking">
                <div class="booking-1">
                    <div class="booking-2">
                        <div class="booking-3">
                            <h2 id="delicious">We Make Delicious &amp; Nutritious Food <br> <a href="#" class="booking_link">Book A Table Now</a></h2>
                        </div>
                    </div>
                </div>
            </section>
