<!DOCTYPE html>
<html lang="en" manifest="https://ndriqa.github.io/PWWW20-21_Gr10/about.html">
  ...
  <header class="night-background">
    ...
    <div class="the-header">
      ...
      <nav class="header-nav-bar ">
        <ul id="menu">
          <li class="nav-item"><a class="nav-link nm-bg" href="./index.php" >HOME</a> </li>
          <li class="nav-item"><a class="nav-link nav-active " href="./about.php" >ABOUT US </a></li>
...
<main>
  <div class="main">
      ...
      <div class="about-section">
        ...
        <div class="inner-container">
          <div>
            <h1>About Us</h1>
            <p class="text">
              At <strong>FRESHNESS</strong>, we create good memories by serving original-style deep-dish pizza using a recipe
              that has been passed down over generations.
              Our restaurant provides an authentic dining experience that is unique to the area. 'Freshness' was worked for
              people in general and has advanced into a combination between exquisite chic and contemporary fine charge.
            </p>
            <div class="skills">
              <span style="color: black;">Enjoy our dazzling dishes and make the most of your eating background with us!</span>
              <button><a href="https://www.google.com/" style="color: white;">Read more >></a></button>
            </div>  
          </div>
        </div>
      </div>  
    ...
    <h3 id="h3" style="text-align:center; font-size: 2.5rem;
      text-align: center;
      font-weight: bold;
      font-style: italic;
      color: var(--our-darker-cyan);">Happy Clients</h3>
    <section id="happy_clients">
      <div class="ins">
  
        <div class="card2">
          <div class="container">
            <img src="./Images/about/clients/team1.jpg" alt="client" />
          </div>
  
          <div class="team">
            <h4 id="hov1">Jane Doe</h4>
            <audio controls>
        ...
        <div class="card2">
          <div class="container">
            <img src="./Images/about/clients/team2.jpg" alt="client" />
          </div>
  
  
          <div class="team">
            <h4 id="hov2">Mike Ross</h4>
            <audio controls>
        ...
        <div class="card2">
          <div class="container">
            <img src="./Images/about/clients/team3.jpg" alt="client" />
          </div>
          <div class="team">
            <h4 id="hov3">Fabiano Caruana</h4>
            <audio controls>
        ...
        <div class="restaurant">
          ...
          font-weight: bold;
          font-style: italic;
          color: var(--our-darker-cyan);">Our specialities? </h3>
          <h4 style="text-align:center; font-size: 1.5rem;
          text-align: center;
          font-weight: bold;
          font-style: italic;
          color: var(--our-darker-cyan);">Watch them in the video below :) </h4>
          <video width="700" height="500" controls>
            <source src="./video/Shots of Different Food.mp4" type="video/mp4">
...
to last throughout the day
  ...
  <script src="./js/nightmode_about.js"></script>
</body>
